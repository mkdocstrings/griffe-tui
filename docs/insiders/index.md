...
*Griffe TUI* follows the **sponsorware** release strategy, which means
...
*Griffe TUI Insiders* is a private fork of *Griffe TUI*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *Griffe TUI*.
...
*Griffe TUI* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *Griffe TUI*,
...
<small>
  ...
  your profile and avatar to show your support for *Griffe TUI*.
...
to use *Griffe TUI* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *Griffe TUI*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *Griffe TUI
Insiders* precisely under the same terms as *Griffe TUI*, which are given
